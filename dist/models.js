...
export function onActiveModelChange(listener) {
    activeListeners.add(listener);
    return () => activeListeners.delete(listener);
}
export function onModelsChange(listener) {
...
function setupRigHandles(item) {
    ...
    chosen.forEach((bone, index) => {
        const handle = new THREE.Mesh(new THREE.SphereGeometry(0.16, 16, 12), new THREE.MeshBasicMaterial({ color: index ? 0x2a7de1 : 0xe15c2a, depthTest: false }));
